    ...
    return (
        <div className="w-full min-h-screen bg-[#33173C] flex-col items-center flex">
            ...
            <Flex className="max-w-[1140px] flex-1 mt-[110px] mb-[10px] w-full bg-[#140F29] border-[1px] border-white">
                <Flex
                    vertical
                    className="border-white border-r-[1px] w-[350px] items-center p-[20px]"
                >
                    <img
                        ...
                        {favoriteMovies.length > 0 ? (
                            <>
                                <div className="flex gap-[10px] items-center mb-[10px] bg-[#2E2E3E] p-[10px] rounded-lg">
                                    ...
                                    <h3 className="text-[20px] text-white font-bold flex-1">
                                        Mô tả
                                    </h3>
...
// const listyeuthichRoutes = require("uploads/");
